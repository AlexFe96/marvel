import { ActionTypes } from '../../actions/mention/comics'
...
const comics = (state = initialState, action) => {
  switch (action.type) {
    case ActionTypes.FETCH_COMICS_BY_HERO_ID:
      return {
        ...state,
        isLoading: true,
      }
    case ActionTypes.FETCH_COMICS_BY_HERO_ID_FAILURE:
      return {
        ...state,
        isLoading: false,
        isFailure: true,
      }
    case ActionTypes.FETCH_COMICS_BY_HERO_ID_SUCCESS:
      return {
        ...state,
    ...
    case ActionTypes.INITIAL_COMICS_PAGINATION:
      return {
        ...state,
    ...
    case ActionTypes.FETCH_PREVIOUS_COMICS_BY_HERO_ID:
      return {
        ...state,
        total: action.payload.data.total,
        limit: action.payload.data.limit,
    ...
    case ActionTypes.FETCH_NEXT_COMICS_BY_HERO_ID:
      return {
        ...state,
        total: action.payload.data.total,
        limit: action.payload.data.limit,
    ...
    case ActionTypes.FETCH_COMICS_ON_CURRENT_PAGE:
      return {
        ...state,
        total: action.payload.data.total,
        limit: action.payload.data.limit,
